...
"""
This script tests whether a robot is ready to play a game, and if not, what specific system is malfunctioning.
"""
...
if __name__ == "__main__":
    ...
    # else:
    #     print_warn("Diagnostics report problepassm. Please use rqt_monitor to investigate.")
    #     if had_diag_error:
    #         print_warn("  There were errors.")
    #     if had_diag_warn:
    #         print_warn("  There were warnings.")
